...
const ALL_QUESTIONS = [
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Kvartál','Vstupenky'],['2','Q1','520'],['3','Q2','680'],['4','Q3','740'],['5','Q4','610'],['6','CELKEM','❓']],
    },
    answerCell: 'B6',
    hint: '=SUM(B2:B5)',
    checkFn: (f) => normalizeFormula(f) === 'SUM(B2:B5)',
    correctFormula: '=SUM(B2:B5)', expectedResult: '2 550',
  },
  {
    funcId: 'SUM',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Zákazník','Město','Platba (Kč)'],['2','Novák','Praha','5000'],['3','Beneš','Brno','3200'],['4','Černá','Ostrava','8500'],['5','Dvořák','Plzeň','2100'],['6','Polák','Liberec','4600'],['7','CELKEM','','❓']],
    },
    answerCell: 'C7',
    hint: '=SUM(C2:C6)',
    checkFn: (f) => normalizeFormula(f) === 'SUM(C2:C6)',
    correctFormula: '=SUM(C2:C6)', expectedResult: '23 400 Kč',
  },
  {
    funcId: 'SUM',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Den','Hodiny'],['2','Pondělí','8'],['3','Úterý','7.5'],['4','Středa','8'],['5','Čtvrtek','8.5'],['6','Pátek','6'],['7','Sobota','4'],['8','Neděle','0'],['9','Přesčas','2'],['10','CELKEM','❓']],
    },
    answerCell: 'B10',
    hint: '=SUM(B2:B9)',
    checkFn: (f) => normalizeFormula(f) === 'SUM(B2:B9)',
    correctFormula: '=SUM(B2:B9)', expectedResult: '44 h',
  },
  {
    funcId: 'SUM',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Období','Příjmy (tis.)'],['2','Q1','1250'],['3','Q2','1480'],['4','Q3','1620'],['5','Q4','1890'],['6','ROČNÍ','❓']],
    },
    answerCell: 'B6',
    hint: '=SUM(B2:B5)',
    checkFn: (f) => normalizeFormula(f) === 'SUM(B2:B5)',
    correctFormula: '=SUM(B2:B5)', expectedResult: '6 240 tis.',
  },
  {
    funcId: 'SUM',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Balík','Váha (kg)'],['2','Balík 1','12'],['3','Balík 2','8.5'],['4','Balík 3','15'],['5','Balík 4','5.5'],['6','Balík 5','10'],['7','Balík 6','7'],['8','CELKEM','❓']],
    },
    answerCell: 'B8',
    hint: '=SUM(B2:B7)',
    checkFn: (f) => normalizeFormula(f) === 'SUM(B2:B7)',
    correctFormula: '=SUM(B2:B7)', expectedResult: '58 kg',
  },
  {
    funcId: 'SUM',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Hráč','Body'],['2','Adam','15'],['3','Bára','22'],['4','Cyril','18'],['5','Dana','12'],['6','Erik','25'],['7','CELKEM','❓']],
    },
    answerCell: 'B7',
    hint: '=SUM(B2:B6)',
    checkFn: (f) => normalizeFormula(f) === 'SUM(B2:B6)',
    correctFormula: '=SUM(B2:B6)', expectedResult: '92',
  },
  {
    funcId: 'SUM',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Položka','Hodnota (Kč)'],['2','Trička','45000'],['3','Kalhoty','72000'],['4','Mikiny','38000'],['5','Boty','89000'],['6','Čepice','12000'],['7','Šály','18000'],['8','Ponožky','9000'],['9','ZÁSOBY','❓']],
    },
    answerCell: 'B9',
    hint: '=SUM(B2:B8)',
    checkFn: (f) => normalizeFormula(f) === 'SUM(B2:B8)',
    correctFormula: '=SUM(B2:B8)', expectedResult: '283 000 Kč',
  },
  {
    funcId: 'SUM',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Den','Km'],['2','Pondělí','120'],['3','Úterý','85'],['4','Středa','150'],['5','Čtvrtek','95'],['6','Pátek','210'],['7','Sobota','45'],['8','CELKEM','❓']],
    },
    answerCell: 'B8',
    hint: '=SUM(B2:B7)',
    checkFn: (f) => normalizeFormula(f) === 'SUM(B2:B7)',
    correctFormula: '=SUM(B2:B7)', expectedResult: '705 km',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Měsíc','Návštěvnost'],['2','Leden','12500'],['3','Únor','11300'],['4','Březen','14800'],['5','Duben','13200'],['6','Květen','14100'],['7','Červen','12700'],['8','Průměr','❓']],
    },
    answerCell: 'B8',
    hint: '=AVERAGE(B2:B7)',
    checkFn: (f) => normalizeFormula(f) === 'AVERAGE(B2:B7)',
    correctFormula: '=AVERAGE(B2:B7)', expectedResult: '13 100',
  },
  {
    funcId: 'AVERAGE',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Produkt','Kategorie','Cena (Kč)'],['2','Tričko','Oblečení','299'],['3','Kalhoty','Oblečení','899'],['4','Bunda','Oblečení','1490'],['5','Čepice','Doplňky','149'],['6','Šála','Doplňky','249'],['7','Průměr','','❓']],
    },
    answerCell: 'C7',
    hint: '=AVERAGE(C2:C6)',
    checkFn: (f) => normalizeFormula(f) === 'AVERAGE(C2:C6)',
    correctFormula: '=AVERAGE(C2:C6)', expectedResult: '617,20 Kč',
  },
  {
    funcId: 'AVERAGE',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Zákazník','Útrata (Kč)'],['2','Novák','2500'],['3','Beneš','1800'],['4','Černá','3200'],['5','Dvořák','1500'],['6','Polák','2900'],['7','Svoboda','2100'],['8','Kovář','2600'],['9','Průměr','❓']],
    },
    answerCell: 'B9',
    hint: '=AVERAGE(B2:B8)',
    checkFn: (f) => normalizeFormula(f) === 'AVERAGE(B2:B8)',
    correctFormula: '=AVERAGE(B2:B8)', expectedResult: '2 371 Kč',
  },
  {
    funcId: 'AVERAGE',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Objednávka','Doba (h)'],['2','OBJ-001','24'],['3','OBJ-002','18'],['4','OBJ-003','36'],['5','OBJ-004','12'],['6','OBJ-005','48'],['7','OBJ-006','20'],['8','OBJ-007','16'],['9','OBJ-008','30'],['10','Průměr','❓']],
    },
    answerCell: 'B10',
    hint: '=AVERAGE(B2:B9)',
    checkFn: (f) => normalizeFormula(f) === 'AVERAGE(B2:B9)',
    correctFormula: '=AVERAGE(B2:B9)', expectedResult: '25,5 h',
  },
  {
    funcId: 'AVERAGE',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Rok','Srážky (mm)'],['2','2019','620'],['3','2020','580'],['4','2021','710'],['5','2022','540'],['6','2023','680'],['7','2024','600'],['8','Průměr','❓']],
    },
    answerCell: 'B8',
    hint: '=AVERAGE(B2:B7)',
    checkFn: (f) => normalizeFormula(f) === 'AVERAGE(B2:B7)',
    correctFormula: '=AVERAGE(B2:B7)', expectedResult: '621,67 mm',
  },
  {
    funcId: 'AVERAGE',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Předmět','Známka'],['2','Matematika','1'],['3','Čeština','2'],['4','Angličtina','3'],['5','Dějepis','1'],['6','Fyzika','4'],['7','Průměr','❓']],
    },
    answerCell: 'B7',
    hint: '=AVERAGE(B2:B6)',
    checkFn: (f) => normalizeFormula(f) === 'AVERAGE(B2:B6)',
    correctFormula: '=AVERAGE(B2:B6)', expectedResult: '2,20',
  },
  {
    funcId: 'AVERAGE',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Jméno','Věk'],['2','Jan Novák','32'],['3','Eva Benešová','28'],['4','Petr Černý','45'],['5','Klára Dvořáková','37'],['6','Tomáš Polák','24'],['7','Lucie Kovářová','41'],['8','Martin Svoboda','33'],['9','Olga Procházková','29'],['10','Průměr','❓']],
    },
    answerCell: 'B10',
    hint: '=AVERAGE(B2:B9)',
    checkFn: (f) => normalizeFormula(f) === 'AVERAGE(B2:B9)',
    correctFormula: '=AVERAGE(B2:B9)', expectedResult: '33,63 let',
  },
  {
    funcId: 'AVERAGE',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Hovor','Délka (min)'],['2','Hovor 1','5'],['3','Hovor 2','12'],['4','Hovor 3','3'],['5','Hovor 4','8'],['6','Hovor 5','15'],['7','Hovor 6','6'],['8','Hovor 7','10'],['9','Průměr','❓']],
    },
    answerCell: 'B9',
    hint: '=AVERAGE(B2:B8)',
    checkFn: (f) => normalizeFormula(f) === 'AVERAGE(B2:B8)',
    correctFormula: '=AVERAGE(B2:B8)', expectedResult: '8,43 min',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Den','Teplota °C'],['2','Po','18'],['3','Út','15'],['4','St','21'],['5','Čt','12'],['6','Pá','16'],['7','So','14'],['8','Ne','19'],['9','Minimum','❓']],
    },
    answerCell: 'B9',
    hint: '=MIN(B2:B8)',
    checkFn: (f) => normalizeFormula(f) === 'MIN(B2:B8)',
    correctFormula: '=MIN(B2:B8)', expectedResult: '12 °C',
  },
  {
    funcId: 'MIN',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Zásilka','Obsah','Váha (kg)'],['2','ZAS-001','Knihy','5.2'],['3','ZAS-002','Oblečení','2.8'],['4','ZAS-003','Elektro','8.5'],['5','ZAS-004','Dokumenty','1.5'],['6','ZAS-005','Nábytek','45'],['7','ZAS-006','Hračky','3.2'],['8','Nejlehčí','','❓']],
    },
    answerCell: 'C8',
    hint: '=MIN(C2:C7)',
    checkFn: (f) => normalizeFormula(f) === 'MIN(C2:C7)',
    correctFormula: '=MIN(C2:C7)', expectedResult: '1,5 kg',
  },
  {
    funcId: 'MIN',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Student','Třída','Skóre'],['2','Adam','3.A','78'],['3','Bára','3.A','45'],['4','Cyril','3.A','92'],['5','Dana','3.A','61'],['6','Erik','3.A','88'],['7','Filip','3.A','53'],['8','Gábina','3.A','74'],['9','Minimum','','❓']],
    },
    answerCell: 'C9',
    hint: '=MIN(C2:C8)',
    checkFn: (f) => normalizeFormula(f) === 'MIN(C2:C8)',
    correctFormula: '=MIN(C2:C8)', expectedResult: '45',
  },
  {
    funcId: 'MIN',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Město','Nájem (Kč/měsíc)'],['2','Praha','15000'],['3','Brno','11000'],['4','Ostrava','8500'],['5','Plzeň','9500'],['6','Liberec','7800'],['7','Olomouc','8200'],['8','Minimum','❓']],
    },
    answerCell: 'B8',
    hint: '=MIN(B2:B7)',
    checkFn: (f) => normalizeFormula(f) === 'MIN(B2:B7)',
    correctFormula: '=MIN(B2:B7)', expectedResult: '7 800 Kč',
  },
  {
    funcId: 'MIN',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Dodavatel','Doba (dny)'],['2','Dodavatel A','3'],['3','Dodavatel B','5'],['4','Dodavatel C','2'],['5','Dodavatel D','7'],['6','Dodavatel E','4'],['7','Dodavatel F','1'],['8','Dodavatel G','6'],['9','Dodavatel H','3'],['10','Minimum','❓']],
    },
    answerCell: 'B10',
    hint: '=MIN(B2:B9)',
    checkFn: (f) => normalizeFormula(f) === 'MIN(B2:B9)',
    correctFormula: '=MIN(B2:B9)', expectedResult: '1 den',
  },
  {
    funcId: 'MIN',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Předmět','Známka'],['2','Matematika','2'],['3','Čeština','1'],['4','Angličtina','3'],['5','Fyzika','4'],['6','Chemie','2'],['7','Dějepis','1'],['8','Biologie','3'],['9','Zeměpis','2'],['10','Informatika','1'],['11','Nejlepší','❓']],
    },
    answerCell: 'B11',
    hint: '=MIN(B2:B10) – nejnižší číslo = nejlepší známka',
    checkFn: (f) => normalizeFormula(f) === 'MIN(B2:B10)',
    correctFormula: '=MIN(B2:B10)', expectedResult: '1',
  },
  {
    funcId: 'MIN',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Vozidlo','Spotřeba (l/100km)'],['2','Škoda Fabia','5.2'],['3','Toyota Yaris','4.8'],['4','VW Golf','6.1'],['5','Fiat 500','4.5'],['6','Ford Fiesta','5.5'],['7','Mini Cooper','6.3'],['8','Suzuki Swift','5.0'],['9','Minimum','❓']],
    },
    answerCell: 'B9',
    hint: '=MIN(B2:B8)',
    checkFn: (f) => normalizeFormula(f) === 'MIN(B2:B8)',
    correctFormula: '=MIN(B2:B8)', expectedResult: '4,5 l/100km',
  },
  {
    funcId: 'MIN',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Produkt','Cena (Kč)'],['2','Tričko','299'],['3','Kalhoty','899'],['4','Bunda','1490'],['5','Čepice','149'],['6','Ponožky','89'],['7','Mikina','1190'],['8','Šála','249'],['9','Rukavice','199'],['10','Nejnižší','❓']],
    },
    answerCell: 'B10',
    hint: '=MIN(B2:B9)',
    checkFn: (f) => normalizeFormula(f) === 'MIN(B2:B9)',
    correctFormula: '=MIN(B2:B9)', expectedResult: '89 Kč',
  },
  {
    funcId: 'MIN',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Účastník','Věk'],['2','Jan','25'],['3','Eva','32'],['4','Petr','18'],['5','Klára','28'],['6','Tomáš','41'],['7','Lucie','22'],['8','Martin','35'],['9','Olga','19'],['10','Nejmladší','❓']],
    },
    answerCell: 'B10',
    hint: '=MIN(B2:B9)',
    checkFn: (f) => normalizeFormula(f) === 'MIN(B2:B9)',
    correctFormula: '=MIN(B2:B9)', expectedResult: '18',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Den','Teplota °C'],['2','Pondělí','22'],['3','Úterý','25'],['4','Středa','19'],['5','Čtvrtek','27'],['6','Pátek','24'],['7','Sobota','21'],['8','Neděle','26'],['9','Maximum','❓']],
    },
    answerCell: 'B9',
    hint: '=MAX(B2:B8)',
    checkFn: (f) => normalizeFormula(f) === 'MAX(B2:B8)',
    correctFormula: '=MAX(B2:B8)', expectedResult: '27 °C',
  },
  {
    funcId: 'MAX',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Kvartál','Produkt','Prodej (tis.)'],['2','Q1','Trička','320'],['3','Q2','Trička','450'],['4','Q3','Trička','380'],['5','Q4','Trička','510'],['6','Nejvyšší prodej','','❓']],
    },
    answerCell: 'C6',
    hint: '=MAX(C2:C5)',
    checkFn: (f) => normalizeFormula(f) === 'MAX(C2:C5)',
    correctFormula: '=MAX(C2:C5)', expectedResult: '510 tis.',
  },
  {
    funcId: 'MAX',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Projekt','Rozpočet (Kč)'],['2','Alpha','500000'],['3','Beta','750000'],['4','Gamma','620000'],['5','Delta','890000'],['6','Epsilon','450000'],['7','Nejvyšší','❓']],
    },
    answerCell: 'B7',
    hint: '=MAX(B2:B6)',
    checkFn: (f) => normalizeFormula(f) === 'MAX(B2:B6)',
    correctFormula: '=MAX(B2:B6)', expectedResult: '890 000 Kč',
  },
  {
    funcId: 'MAX',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Student','Třída','Skóre'],['2','Novák','3.A','78'],['3','Benešová','3.A','92'],['4','Černý','3.A','85'],['5','Dvořáková','3.A','67'],['6','Polák','3.A','95'],['7','Svobodová','3.A','88'],['8','Kovář','3.A','73'],['9','Nejvyšší','','❓']],
    },
    answerCell: 'C9',
    hint: '=MAX(C2:C8)',
    checkFn: (f) => normalizeFormula(f) === 'MAX(C2:C8)',
    correctFormula: '=MAX(C2:C8)', expectedResult: '95',
  },
  {
    funcId: 'MAX',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Měsíc','Tržba (Kč)'],['2','Leden','125000'],['3','Únor','98000'],['4','Březen','152000'],['5','Duben','114000'],['6','Květen','138000'],['7','Červen','161000'],['8','Červenec','175000'],['9','Srpen','143000'],['10','Září','126000'],['11','Říjen','119000'],['12','Listopad','135000'],['13','Prosinec','189000'],['14','Nejvyšší','❓']],
    },
    answerCell: 'B14',
    hint: '=MAX(B2:B13)',
    checkFn: (f) => normalizeFormula(f) === 'MAX(B2:B13)',
    correctFormula: '=MAX(B2:B13)', expectedResult: '189 000 Kč',
  },
  {
    funcId: 'MAX',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Lokalita','Cena (Kč)'],['2','Praha','8500000'],['3','Brno','5200000'],['4','Ostrava','3800000'],['5','Plzeň','4200000'],['6','Liberec','3500000'],['7','Hradec','2900000'],['8','Olomouc','3100000'],['9','Maximum','❓']],
    },
    answerCell: 'B9',
    hint: '=MAX(B2:B8)',
    checkFn: (f) => normalizeFormula(f) === 'MAX(B2:B8)',
    correctFormula: '=MAX(B2:B8)', expectedResult: '8 500 000 Kč',
  },
  {
    funcId: 'MAX',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Den','Návštěvníci'],['2','Pondělí','120'],['3','Úterý','95'],['4','Středa','150'],['5','Čtvrtek','180'],['6','Pátek','220'],['7','Sobota','310'],['8','Neděle','200'],['9','Nejvíce','❓']],
    },
    answerCell: 'B9',
    hint: '=MAX(B2:B8)',
    checkFn: (f) => normalizeFormula(f) === 'MAX(B2:B8)',
    correctFormula: '=MAX(B2:B8)', expectedResult: '310',
  },
  {
    funcId: 'MAX',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Hora','Výška (m n.m.)'],['2','Sněžka','1603'],['3','Klínovec','1244'],['4','Radhošť','1129'],['5','Praděd','1491'],['6','Lysá hora','1323'],['7','Javořice','837'],['8','Maximum','❓']],
    },
    answerCell: 'B8',
    hint: '=MAX(B2:B7)',
    checkFn: (f) => normalizeFormula(f) === 'MAX(B2:B7)',
    correctFormula: '=MAX(B2:B7)', expectedResult: '1 603 m',
  },
  {
    funcId: 'MAX',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Vozidlo','Rychlost (km/h)'],['2','Škoda Octavia','185'],['3','VW Passat','210'],['4','BMW X5','230'],['5','Audi A4','220'],['6','Ford Mondeo','195'],['7','Mercedes C','225'],['8','Toyota Avensis','190'],['9','Mazda 6','205'],['10','Nejvyšší','❓']],
    },
    answerCell: 'B10',
    hint: '=MAX(B2:B9)',
    checkFn: (f) => normalizeFormula(f) === 'MAX(B2:B9)',
    correctFormula: '=MAX(B2:B9)', expectedResult: '230 km/h',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Závodník','Město','Čas (min)'],['2','Adam','Praha','32'],['3','Bára','Brno','28'],['4','Cyril','Ostrava','–'],['5','David','Plzeň','31'],['6','Eva','Liberec',''],['7','Filip','Hradec','27'],['8','Gábina','Jihlava','–'],['9','Počet časů','','❓']],
    },
    answerCell: 'C9',
    hint: '=COUNT(C2:C8) počítá jen čísla',
    checkFn: (f) => normalizeFormula(f) === 'COUNT(C2:C8)',
    correctFormula: '=COUNT(C2:C8)', expectedResult: '4',
  },
  {
    funcId: 'COUNT',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Prodejce','Den','Zboží','Částka'],['2','Novák','Po','Trička','5000'],['3','Beneš','Út','Kalhoty','–'],['4','Černá','St','Boty','8200'],['5','Dvořák','Čt','Čepice',''],['6','Polák','Pá','Mikiny','3200'],['7','Kovář','So','Šály','–'],['8','Počet prodejů','','','❓']],
    },
    answerCell: 'D8',
    hint: '=COUNT(D2:D7)',
    checkFn: (f) => normalizeFormula(f) === 'COUNT(D2:D7)',
    correctFormula: '=COUNT(D2:D7)', expectedResult: '3',
  },
  {
    funcId: 'COUNT',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Student','Projekt','Známka'],['2','Jan','Web','85'],['3','Eva','SQL',''],['4','Petr','Python','92'],['5','Klára','',''],['6','Tomáš','Java','78'],['7','Lucie','UX',''],['8','Martin','C#','88'],['9','Olga','',''],['10','Radek','PHP','75'],['11','Počet odevzdaných','','❓']],
    },
    answerCell: 'C11',
    hint: '=COUNT(C2:C10)',
    checkFn: (f) => normalizeFormula(f) === 'COUNT(C2:C10)',
    correctFormula: '=COUNT(C2:C10)', expectedResult: '5',
  },
  {
    funcId: 'COUNT',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Den','Teplota °C'],['2','1.','25'],['3','2.',''],['4','3.','28'],['5','4.','–'],['6','5.','22'],['7','6.',''],['8','7.','30'],['9','8.','27'],['10','9.',''],['11','10.','24'],['12','11.','–'],['13','12.','26'],['14','13.',''],['15','14.','29'],['16','15.','23'],['17','16.',''],['18','17.','31'],['19','18.',''],['20','19.','28'],['21','20.','24'],['22','21.',''],['23','22.',''],['24','23.','27'],['25','24.','–'],['26','25.','25'],['27','26.',''],['28','27.','22'],['29','28.','–'],['30','29.','26'],['31','30.','30'],['32','Počet měření','❓']],
    },
    answerCell: 'B32',
    hint: '=COUNT(B2:B31)',
    checkFn: (f) => normalizeFormula(f) === 'COUNT(B2:B31)',
    correctFormula: '=COUNT(B2:B31)', expectedResult: '15',
  },
  {
    funcId: 'COUNT',
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Faktura','Částka (Kč)'],['2','FAKT-001','15000'],['3','FAKT-002',''],['4','FAKT-003','22000'],['5','FAKT-004',''],['6','FAKT-005','5000'],['7','FAKT-006','12000'],['8','FAKT-007',''],['9','Počet faktur','❓']],
    },
    answerCell: 'B9',
    hint: '=COUNT(B2:B8)',
    checkFn: (f) => normalizeFormula(f) === 'COUNT(B2:B8)',
    correctFormula: '=COUNT(B2:B8)', expectedResult: '4',
  },
  {
    funcId: 'COUNT',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Čas','SPZ','Mýtné (Kč)'],['2','8:05','1AB 1234','150'],['3','8:12','2CD 5678','–'],['4','8:20','',''],['5','8:31','3EF 9012','150'],['6','8:45','4GH 3456','230'],['7','9:02','',''],['8','9:15','5IJ 7890','150'],['9','9:22','6KL 0123',''],['10','9:40','7MN 3456','230'],['11','Počet vozidel','','❓']],
    },
    answerCell: 'C11',
    hint: '=COUNT(C2:C10)',
    checkFn: (f) => normalizeFormula(f) === 'COUNT(C2:C10)',
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Účastník','Věk'],['2','Jan Novák','25'],['3','Eva Benešová',''],['4','Petr Černý','32'],['5','Klára Dvořáková','28'],['6','Tomáš Polák',''],['7','Lucie Kovářová','41'],['8','Martin Svoboda',''],['9','Olga Procházková','35'],['10','Radek Veselý',''],['11','Počet vyplněných','❓']],
    },
    answerCell: 'B11',
    hint: '=COUNT(B2:B10)',
    checkFn: (f) => normalizeFormula(f) === 'COUNT(B2:B10)',
    correctFormula: '=COUNT(B2:B10)', expectedResult: '5',
  },
  {
    funcId: 'COUNT',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Objednávka','Položka','Množství'],['2','OBJ-001','Trička','50'],['3','OBJ-002','Kalhoty','–'],['4','OBJ-003','Mikiny','25'],['5','OBJ-004','Boty',''],['6','OBJ-005','Čepice','12'],['7','OBJ-006','Šály','30'],['8','OBJ-007','Ponožky',''],['9','Počet objednávek','','❓']],
    },
    answerCell: 'C9',
    hint: '=COUNT(C2:C8)',
    checkFn: (f) => normalizeFormula(f) === 'COUNT(C2:C8)',
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','ID','Produkt','Kategorie','Cena'],['2','P001','Tričko','Oblečení','299'],['3','P002','Kalhoty','Oblečení','899'],['4','P003','Bunda','Oblečení','1490'],['5','P004','Mikina','Oblečení',''],['6','P005','Čepice','Doplňky','149'],['7','P006','Šála','Doplňky','249'],['8','P007','Rukavice','Doplňky',''],['9','Počet cen','','','❓']],
    },
    answerCell: 'D9',
    hint: '=COUNT(D2:D8)',
    checkFn: (f) => normalizeFormula(f) === 'COUNT(D2:D8)',
    correctFormula: '=COUNT(D2:D8)', expectedResult: '5',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Jméno','Předmět','Skóre','Výsledek'],['2','Klára','Matematika','85','❓'],['3','Radek','Matematika','45',''],['4','Lenka','Matematika','72','']],
    },
    answerCell: 'D2',
    hint: '=IF(C2>=60,"Prospěl","Neprospěl")',
    checkFn: (f) => normalizeFormula(f) === 'IF(C2>=60,"PROSPĚL","NEPROSPĚL")' || normalizeFormula(f) === 'IF(C2>=60,"PROSPEL","NEPROSPEL")',
    correctFormula: '=IF(C2>=60,"Prospěl","Neprospěl")', expectedResult: '"Prospěl"',
  },
  {
    funcId: 'IF',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Produkt','Cena','Kategorie'],['2','Notebook','24990','❓'],['3','Myš','450',''],['4','Monitor','5990','']],
    },
    answerCell: 'C2',
    hint: '=IF(B2>1000,"Drahý","Levný")',
    checkFn: (f) => normalizeFormula(f) === 'IF(B2>1000,"DRAHÝ","LEVNÝ")' || normalizeFormula(f) === 'IF(B2>1000,"DRAHY","LEVNY")',
    correctFormula: '=IF(B2>1000,"Drahý","Levný")', expectedResult: '"Drahý"',
  },
  {
    funcId: 'IF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Jméno','Třída','Docházka %','Hodnocení'],['2','Tomáš','3.A','95','❓'],['3','Eva','3.A','78',''],['4','Petr','3.A','88','']],
    },
    answerCell: 'D2',
    hint: '=IF(C2>=90,"Pochvala","Napomenutí")',
    checkFn: (f) => normalizeFormula(f) === 'IF(C2>=90,"POCHVALA","NAPOMENUTÍ")' || normalizeFormula(f) === 'IF(C2>=90,"POCHVALA","NAPOMENUTI")',
    correctFormula: '=IF(C2>=90,"Pochvala","Napomenutí")', expectedResult: '"Pochvala"',
  },
  {
    funcId: 'IF',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Produkt','Skladem','Status'],['2','Tričko','Ano','❓'],['3','Bunda','Ne',''],['4','Čepice','Ano','']],
    },
    answerCell: 'C2',
    hint: '=IF(B2="Ano","Dostupný","Nedostupný")',
    checkFn: (f) => normalizeFormula(f) === 'IF(B2="ANO","DOSTUPNÝ","NEDOSTUPNÝ")' || normalizeFormula(f) === 'IF(B2="ANO","DOSTUPNY","NEDOSTUPNY")',
    correctFormula: '=IF(B2="Ano","Dostupný","Nedostupný")', expectedResult: '"Dostupný"',
  },
  {
    funcId: 'IF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Zásilka','Obsah','Váha (kg)','Kategorie'],['2','ZAS-001','Knihy','5','❓'],['3','ZAS-002','Nábytek','45',''],['4','ZAS-003','Oblečení','2','']],
    },
    answerCell: 'D2',
    hint: '=IF(C2>20,"Nadměrný","Standard")',
    checkFn: (f) => normalizeFormula(f) === 'IF(C2>20,"NADMĚRNÝ","STANDARD")' || normalizeFormula(f) === 'IF(C2>20,"NADMERNY","STANDARD")',
    correctFormula: '=IF(C2>20,"Nadměrný","Standard")', expectedResult: '"Standard"',
  },
  {
    funcId: 'IF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Student','Předmět','Průměr','Hodnocení'],['2','Anna','Fyzika','1.5','❓'],['3','Pavel','Fyzika','3.0',''],['4','Lenka','Fyzika','1.8','']],
    },
    answerCell: 'D2',
    hint: '=IF(C2<2.5,"Výborný","Dobrý")',
    checkFn: (f) => normalizeFormula(f) === 'IF(C2<2.5,"VÝBORNÝ","DOBRÝ")' || normalizeFormula(f) === 'IF(C2<2.5,"VYBORNY","DOBRY")',
    correctFormula: '=IF(C2<2.5,"Výborný","Dobrý")', expectedResult: '"Výborný"',
  },
  {
    funcId: 'IF',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Jméno','Pohlaví','Oslovení'],['2','Jan Novák','Muž','❓'],['3','Eva Černá','Žena',''],['4','Pavel Dvořák','Muž','']],
    },
    answerCell: 'C2',
    hint: '=IF(B2="Muž","Vážený","Vážená")',
    checkFn: (f) => normalizeFormula(f) === 'IF(B2="MUŽ","VÁŽENÝ","VÁŽENÁ")' || normalizeFormula(f) === 'IF(B2="MUZ","VAZENY","VAZENA")',
    correctFormula: '=IF(B2="Muž","Vážený","Vážená")', expectedResult: '"Vážený"',
  },
  {
    funcId: 'IF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Město','Den','Teplota','Poznámka'],['2','Praha','1.7.','35','❓'],['3','Brno','1.7.','28',''],['4','Ostrava','1.7.','31','']],
    },
    answerCell: 'D2',
    hint: '=IF(C2>30,"Horko","Normál")',
    checkFn: (f) => normalizeFormula(f) === 'IF(C2>30,"HORKO","NORMÁL")' || normalizeFormula(f) === 'IF(C2>30,"HORKO","NORMAL")',
    correctFormula: '=IF(C2>30,"Horko","Normál")', expectedResult: '"Horko"',
  },
  {
    funcId: 'IF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Jméno','Město','Věk','Status'],['2','Adam','Praha','22','❓'],['3','Lucie','Brno','16',''],['4','David','Ostrava','18','']],
    },
    answerCell: 'D2',
    hint: '=IF(C2>=18,"Zletilý","Nezletilý")',
    checkFn: (f) => normalizeFormula(f) === 'IF(C2>=18,"ZLETILÝ","NEZLETILÝ")' || normalizeFormula(f) === 'IF(C2>=18,"ZLETILY","NEZLETILY")',
    correctFormula: '=IF(C2>=18,"Zletilý","Nezletilý")', expectedResult: '"Zletilý"',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B','','E','F','G'],
      rows: [['1','','','','Hledám:','Myš',''],['2','','','','Cena:','❓',''],['3','Monitor','5990','','','',''],['4','Klávesnice','890','','','',''],['5','Myš','450','','','',''],['6','Headset','1290','','','',''],['7','Webkamera','890','','','','']],
    },
    answerCell: 'F2',
    hint: '=VLOOKUP(F1,A3:B7,2,0)',
    checkFn: (f) => normalizeFormula(f) === 'VLOOKUP(F1,A3:B7,2,0)' || normalizeFormula(f) === 'VLOOKUP(F1,A3:B7,2,0)',
    correctFormula: '=VLOOKUP(F1,A3:B7,2,0)', expectedResult: '450',
  },
  {
    funcId: 'VLOOKUP',
    ...
    table: {
      headers: ['','A','B','','E','F'],
      rows: [['1','Jméno','Telefon','','Hledám:','Jan Novák'],['2','Jan Novák','777 123 456','','Telefon:','❓'],['3','Petr Černý','777 789 012','','',''],['4','Eva Benešová','605 111 222','','',''],['5','Josef Dvořák','724 333 444','','',''],['6','Marie Poláková','602 555 666','','','']],
    },
    answerCell: 'F2',
    hint: '=VLOOKUP(F1,A2:B6,2,0)',
    checkFn: (f) => normalizeFormula(f) === 'VLOOKUP(F1,A2:B6,2,0)',
    correctFormula: '=VLOOKUP(F1,A2:B6,2,0)', expectedResult: '"777 123 456"',
  },
  {
    funcId: 'VLOOKUP',
    ...
    table: {
      headers: ['','A','B','','E','F'],
      rows: [['1','Potravina','Cena','','Hledám:','Chléb'],['2','Mléko','25','','Cena:','❓'],['3','Chléb','38','','',''],['4','Máslo','45','','',''],['5','Sýr','89','','',''],['6','Šunka','120','','',''],['7','Jogurt','18','','','']],
    },
    answerCell: 'F2',
    hint: '=VLOOKUP(F1,A2:B7,2,0)',
    checkFn: (f) => normalizeFormula(f) === 'VLOOKUP(F1,A2:B7,2,0)',
    correctFormula: '=VLOOKUP(F1,A2:B7,2,0)', expectedResult: '38',
  },
  {
    funcId: 'VLOOKUP',
    ...
    table: {
      headers: ['','A','B','','E','F'],
      rows: [['1','Hráč','Skóre','','Hledám:','Lucie'],['2','Tomáš','4200','','Skóre:','❓'],['3','Petra','5800','','',''],['4','Lucie','6100','','',''],['5','Martin','5500','','',''],['6','Eva','4750','','','']],
    },
    answerCell: 'F2',
    hint: '=VLOOKUP(F1,A2:B6,2,0)',
    checkFn: (f) => normalizeFormula(f) === 'VLOOKUP(F1,A2:B6,2,0)',
    correctFormula: '=VLOOKUP(F1,A2:B6,2,0)', expectedResult: '6 100',
  },
  {
    funcId: 'VLOOKUP',
    ...
    table: {
      headers: ['','A','B','C','','F','G'],
      rows: [['1','Jméno','ID','Oddělení','','Hledám:','Petr Černý'],['2','Jan Novák','E001','IT','','Oddělení:','❓'],['3','Petr Černý','E002','HR','','',''],['4','Eva Benešová','E003','Finance','','',''],['5','Josef Dvořák','E004','IT','','',''],['6','Marie Poláková','E005','Marketing','','','']],
    },
    answerCell: 'G2',
    hint: '=VLOOKUP(G1,A2:C6,3,0)',
    checkFn: (f) => normalizeFormula(f) === 'VLOOKUP(G1,A2:C6,3,0)',
    correctFormula: '=VLOOKUP(G1,A2:C6,3,0)', expectedResult: '"HR"',
  },
  {
    funcId: 'VLOOKUP',
    ...
    table: {
      headers: ['','A','B','','E','F'],
      rows: [['1','Produkt','Sklad','','Hledám:','XYZ-2024'],['2','ABC-001','Sklad A','','Sklad:','❓'],['3','DEF-2024','Sklad B','','',''],['4','XYZ-2024','Sklad C','','',''],['5','GHI-001','Sklad A','','',''],['6','JKL-2024','Sklad B','','',''],['7','MNO-001','Sklad C','','','']],
    },
    answerCell: 'F2',
    hint: '=VLOOKUP(F1,A2:B7,2,0)',
    checkFn: (f) => normalizeFormula(f) === 'VLOOKUP(F1,A2:B7,2,0)',
    correctFormula: '=VLOOKUP(F1,A2:B7,2,0)', expectedResult: '"Sklad C"',
  },
  {
    funcId: 'VLOOKUP',
    ...
    table: {
      headers: ['','A','B','','F','G'],
      rows: [['1','ID','Cena','','Hledám:','P003'],['2','P001','299','','Cena:','❓'],['3','P002','599','','',''],['4','P003','399','','',''],['5','P004','899','','',''],['6','P005','149','','','']],
    },
    answerCell: 'G2',
    hint: '=VLOOKUP(G1,A2:B6,2,0)',
    checkFn: (f) => normalizeFormula(f) === 'VLOOKUP(G1,A2:B6,2,0)',
    correctFormula: '=VLOOKUP(G1,A2:B6,2,0)', expectedResult: '399',
  },
  {
    funcId: 'VLOOKUP',
    ...
    table: {
      headers: ['','A','B','','E','F'],
      rows: [['1','Kód','Země','','Hledám:','CZ'],['2','CZ','Česká republika','','Země:','❓'],['3','SK','Slovensko','','',''],['4','PL','Polsko','','',''],['5','DE','Německo','','',''],['6','AT','Rakousko','','',''],['7','HU','Maďarsko','','',''],['8','FR','Francie','','','']],
    },
    answerCell: 'F2',
    hint: '=VLOOKUP(F1,A2:B8,2,0)',
    checkFn: (f) => normalizeFormula(f) === 'VLOOKUP(F1,A2:B8,2,0)',
    correctFormula: '=VLOOKUP(F1,A2:B8,2,0)', expectedResult: '"Česká republika"',
  },
  {
    funcId: 'VLOOKUP',
    ...
    table: {
      headers: ['','A','B','','E','F'],
      rows: [['1','Film','Hodnocení','','Hledám:','Film D'],['2','Film A','8.5','','Hodnocení:','❓'],['3','Film B','7.2','','',''],['4','Film C','9.1','','',''],['5','Film D','6.8','','',''],['6','Film E','8.0','','','']],
    },
    answerCell: 'F2',
    hint: '=VLOOKUP(F1,A2:B6,2,0)',
    checkFn: (f) => normalizeFormula(f) === 'VLOOKUP(F1,A2:B6,2,0)',
    correctFormula: '=VLOOKUP(F1,A2:B6,2,0)', expectedResult: '6,8',
  },
  {
    funcId: 'VLOOKUP',
    ...
    table: {
      headers: ['','A','B','','E','F'],
      rows: [['1','Velikost','Barva','','Hledám:','XL'],['2','S','Bílá','','Barva:','❓'],['3','M','Černá','','',''],['4','L','Modrá','','',''],['5','XL','Červená','','',''],['6','XXL','Zelená','','','']],
    },
    answerCell: 'F2',
    hint: '=VLOOKUP(F1,A2:B6,2,0)',
    checkFn: (f) => normalizeFormula(f) === 'VLOOKUP(F1,A2:B6,2,0)',
    correctFormula: '=VLOOKUP(F1,A2:B6,2,0)', expectedResult: '"Červená"',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','Položky','❓'],['2','Monitor',''],['3','Klávesnice',''],['4','Myš',''],['5','',''],['6','Repro',''],['7','',''],['8','Kabel HDMI',''],['9','Tablet','']],
    },
    answerCell: 'B1',
    hint: '=COUNTA(A2:A9)',
    checkFn: (f) => normalizeFormula(f) === 'COUNTA(A2:A9)',
    correctFormula: '=COUNTA(A2:A9)', expectedResult: '6',
  },
  {
    funcId: 'COUNTA',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','ID','Jméno','Počet zaměstnanců','❓'],['2','001','Novák Jan','',''],['3','002','','',''],['4','003','Benešová Eva','',''],['5','004','Černý Petr','',''],['6','005','','',''],['7','006','Dvořák Josef','',''],['8','007','Poláková Jana','',''],['9','008','','',''],['10','009','Kovář Tomáš','','']],
    },
    answerCell: 'D1',
    hint: '=COUNTA(B2:B10)',
    checkFn: (f) => normalizeFormula(f) === 'COUNTA(B2:B10)',
    correctFormula: '=COUNTA(B2:B10)', expectedResult: '6',
  },
  {
    funcId: 'COUNTA',
    ...
    table: {
      headers: ['','D','E','F','G'],
      rows: [['1','Kurz','Účastník','Zapsáno','❓'],['2','K001','Jan Novák','',''],['3','K001','','',''],['4','K001','Petr Černý','',''],['5','K002','Eva Benešová','',''],['6','K002','Josef Dvořák','',''],['7','K002','','',''],['8','K003','','',''],['9','K003','Marie Poláková','',''],['10','K003','Tomáš Kovář','','']],
    },
    answerCell: 'G1',
    hint: '=COUNTA(E2:E10)',
    checkFn: (f) => normalizeFormula(f) === 'COUNTA(E2:E10)',
    correctFormula: '=COUNTA(E2:E10)', expectedResult: '6',
  },
  {
    funcId: 'COUNTA',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Produkt','Popis','Počet popisů','❓'],['2','Tričko','Bavlněné tričko','',''],['3','Kalhoty','Džíny','',''],['4','Bunda','','',''],['5','Čepice','Kšiltovka','',''],['6','Ponožky','','',''],['7','Mikina','Bavlněná mikina','',''],['8','Šála','Krkavice','',''],['9','Rukavice','','',''],['10','Kabát','Zimní kabát','','']],
    },
    answerCell: 'D1',
    hint: '=COUNTA(B2:B10)',
    checkFn: (f) => normalizeFormula(f) === 'COUNTA(B2:B10)',
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B'],
      rows: [['1','E-maily','❓'],['2','jan@email.cz',''],['3','petr@seznam.cz',''],['4','',''],['5','eva@email.cz',''],['6','',''],['7','',''],['8','josef@email.cz',''],['9','marie@seznam.cz',''],['10','',''],['11','tomas@email.cz',''],['12','','']],
    },
    answerCell: 'B1',
    hint: '=COUNTA(A2:A12)',
    checkFn: (f) => normalizeFormula(f) === 'COUNTA(A2:A12)',
    correctFormula: '=COUNTA(A2:A12)', expectedResult: '6',
  },
  {
    funcId: 'COUNTA',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Vozidlo','SPZ','Počet SPZ','❓'],['2','Škoda Octavia','1AB 1234','',''],['3','VW Golf','','',''],['4','BMW X5','2CD 5678','',''],['5','Audi A4','3EF 9012','',''],['6','Ford Focus','','',''],['7','Škoda Fabia','4GH 3456','',''],['8','Toyota Corolla','','',''],['9','Mercedes C','5IJ 7890','','']],
    },
    answerCell: 'D1',
    hint: '=COUNTA(B2:B9)',
    checkFn: (f) => normalizeFormula(f) === 'COUNTA(B2:B9)',
    correctFormula: '=COUNTA(B2:B9)', expectedResult: '5',
  },
  {
    funcId: 'COUNTA',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Recept','Ingredience','Počet','❓'],['2','Svíčková','Maso, smetana, zelenina','',''],['3','Řízek','Maso, strouhanka, vejce','',''],['4','Guláš','','',''],['5','Knedlíky','Mouka, vejce, mléko','',''],['6','Polévka','Zelenina, vývar','',''],['7','Bramborák','','',''],['8','Salát','Zelenina, dresink','',''],['9','Palačinky','Mouka, mléko, vejce','',''],['10','Zmrzlina','','','']],
    },
    answerCell: 'D1',
    hint: '=COUNTA(B2:B10)',
    checkFn: (f) => normalizeFormula(f) === 'COUNTA(B2:B10)',
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Kniha','Autor','Počet autorů','❓'],['2','Kniha 1','Autor A','',''],['3','Kniha 2','','',''],['4','Kniha 3','Autor B','',''],['5','Kniha 4','Autor C','',''],['6','Kniha 5','','',''],['7','Kniha 6','Autor D','',''],['8','Kniha 7','Autor B','',''],['9','Kniha 8','','',''],['10','Kniha 9','Autor E','',''],['11','Kniha 10','','',''],['12','Kniha 11','Autor F','','']],
    },
    answerCell: 'D1',
    hint: '=COUNTA(B2:B12)',
    checkFn: (f) => normalizeFormula(f) === 'COUNTA(B2:B12)',
    correctFormula: '=COUNTA(B2:B12)', expectedResult: '7',
  },
  {
    funcId: 'COUNTA',
    ...
    table: {
      headers: ['','A','B','C','D','E'],
      rows: [['1','Název','Rok','Žánr','Počet žánrů','❓'],['2','Film 1','2020','Komedie','',''],['3','Film 2','2021','','',''],['4','Film 3','2019','Drama','',''],['5','Film 4','2022','','',''],['6','Film 5','2020','Akční','',''],['7','Film 6','2021','Drama','',''],['8','Film 7','2022','','',''],['9','Film 8','2023','Komedie','',''],['10','Film 9','2023','','','']],
    },
    answerCell: 'E1',
    hint: '=COUNTA(C2:C10)',
    checkFn: (f) => normalizeFormula(f) === 'COUNTA(C2:C10)',
    correctFormula: '=COUNTA(C2:C10)', expectedResult: '5',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Objednávka','Stav','','Počet Dokončeno'],['2','OBJ-001','Dokončeno','','❓'],['3','OBJ-002','Zpracovává se','',''],['4','OBJ-003','Dokončeno','',''],['5','OBJ-004','Stornováno','',''],['6','OBJ-005','Dokončeno','',''],['7','OBJ-006','Dokončeno','',''],['8','OBJ-007','Zpracovává se','','']],
    },
    answerCell: 'D2',
    hint: '=COUNTIF(B2:B8,"Dokončeno")',
    checkFn: (f) => normalizeFormula(f) === 'COUNTIF(B2:B8,"DOKONČENO")',
    correctFormula: '=COUNTIF(B2:B8,"Dokončeno")', expectedResult: '4',
  },
  {
    funcId: 'COUNTIF',
    ...
    table: {
      headers: ['','A','B','C'],
      rows: [['1','Prospěch','Student','❓'],['2','1','Novák',''],['3','2','Beneš',''],['4','1','Černá',''],['5','3','Dvořák',''],['6','1','Polák',''],['7','2','Svoboda',''],['8','1','Kovář',''],['9','4','Procházka','']],
    },
    answerCell: 'C1',
    hint: '=COUNTIF(A2:A9,1) nebo =COUNTIF(A2:A9,"1")',
    checkFn: (f) => normalizeFormula(f) === 'COUNTIF(A2:A9,1)' || normalizeFormula(f) === 'COUNTIF(A2:A9,"1")',
    correctFormula: '=COUNTIF(A2:A9,1)', expectedResult: '4',
  },
  {
    funcId: 'COUNTIF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Zaměstnanec','Hodiny','Počet >40','❓'],['2','Novák','42','',''],['3','Beneš','38','',''],['4','Černá','45','',''],['5','Dvořák','40','',''],['6','Polák','50','',''],['7','Svoboda','36','','']],
    },
    answerCell: 'D1',
    hint: '=COUNTIF(B2:B7,">40") počítá hodnoty větší než 40',
    checkFn: (f) => normalizeFormula(f) === 'COUNTIF(B2:B7,">40")',
    correctFormula: '=COUNTIF(B2:B7,">40")', expectedResult: '3',
  },
  {
    funcId: 'COUNTIF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Výrobek','Cena','Počet <1000','❓'],['2','Tričko','299','',''],['3','Kalhoty','899','',''],['4','Bunda','1490','',''],['5','Ponožky','89','',''],['6','Čepice','149','',''],['7','Mikina','1190','',''],['8','Šála','249','','']],
    },
    answerCell: 'D1',
    hint: '=COUNTIF(B2:B8,"<1000")',
    checkFn: (f) => normalizeFormula(f) === 'COUNTIF(B2:B8,"<1000")',
    correctFormula: '=COUNTIF(B2:B8,"<1000")', expectedResult: '5',
  },
  {
    funcId: 'COUNTIF',
    ...
    table: {
      headers: ['','A','B','C','D','E'],
      rows: [['1','Název','Umělec','Žánr','Počet Rock','❓'],['2','Song A','Umělec 1','Rock','',''],['3','Song B','Umělec 2','Pop','',''],['4','Song C','Umělec 3','Rock','',''],['5','Song D','Umělec 1','Jazz','',''],['6','Song E','Umělec 4','Rock','',''],['7','Song F','Umělec 2','Pop','',''],['8','Song G','Umělec 5','Rock','',''],['9','Song H','Umělec 3','Rock','','']],
    },
    answerCell: 'E1',
    hint: '=COUNTIF(C2:C9,"Rock")',
    checkFn: (f) => normalizeFormula(f) === 'COUNTIF(C2:C9,"ROCK")',
    correctFormula: '=COUNTIF(C2:C9,"Rock")', expectedResult: '5',
  },
  {
    funcId: 'COUNTIF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Den','Teplota','Počet >30','❓'],['2','1.7.','32','',''],['3','2.7.','28','',''],['4','3.7.','35','',''],['5','4.7.','31','',''],['6','5.7.','27','',''],['7','6.7.','33','',''],['8','7.7.','36','',''],['9','8.7.','29','',''],['10','9.7.','34','',''],['11','10.7.','30','','']],
    },
    answerCell: 'D1',
    hint: '=COUNTIF(B2:B11,">30")',
    checkFn: (f) => normalizeFormula(f) === 'COUNTIF(B2:B11,">30")',
    correctFormula: '=COUNTIF(B2:B11,">30")', expectedResult: '6',
  },
  {
    funcId: 'COUNTIF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Zákazník','Město','Počet Praha','❓'],['2','Novák','Praha','',''],['3','Beneš','Brno','',''],['4','Černá','Praha','',''],['5','Dvořák','Ostrava','',''],['6','Polák','Praha','',''],['7','Svoboda','Praha','',''],['8','Kovář','Brno','','']],
    },
    answerCell: 'D1',
    hint: '=COUNTIF(B2:B8,"Praha")',
    checkFn: (f) => normalizeFormula(f) === 'COUNTIF(B2:B8,"PRAHA")',
    correctFormula: '=COUNTIF(B2:B8,"Praha")', expectedResult: '4',
  },
  {
    funcId: 'COUNTIF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Závodník','Dokončil','Počet','❓'],['2','Závodník 1','Ano','',''],['3','Závodník 2','Ne','',''],['4','Závodník 3','Ano','',''],['5','Závodník 4','Ano','',''],['6','Závodník 5','Ne','',''],['7','Závodník 6','Ano','',''],['8','Závodník 7','Ano','','']],
    },
    answerCell: 'D1',
    hint: '=COUNTIF(B2:B8,"Ano")',
    checkFn: (f) => normalizeFormula(f) === 'COUNTIF(B2:B8,"ANO")',
    correctFormula: '=COUNTIF(B2:B8,"Ano")', expectedResult: '5',
  },
  {
    funcId: 'COUNTIF',
    ...
    table: {
      headers: ['','A','B','C','D','E'],
      rows: [['1','Faktura','Částka','Status','Počet po splatnosti','❓'],['2','FAKT-001','15000','Zaplaceno','',''],['3','FAKT-002','8000','Po splatnosti','',''],['4','FAKT-003','22000','Zaplaceno','',''],['5','FAKT-004','5000','Po splatnosti','',''],['6','FAKT-005','12000','Po splatnosti','',''],['7','FAKT-006','30000','Zaplaceno','',''],['8','FAKT-007','18000','Po splatnosti','','']],
    },
    answerCell: 'E1',
    hint: '=COUNTIF(C2:C8,"Po splatnosti")',
    checkFn: (f) => normalizeFormula(f) === 'COUNTIF(C2:C8,"PO SPLATNOSTI")',
    correctFormula: '=COUNTIF(C2:C8,"Po splatnosti")', expectedResult: '4',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['','A','B','C','D','E'],
      rows: [['1','Region','Zástupce','Prodej','Hledám:','Jih'],['2','Sever','Kovář','45000','Součet:',''],['3','Jih','Beneš','32000','','❓'],['4','Jih','Nová','27000','',''],['5','Západ','Pospíšil','38000','',''],['6','Sever','Kolář','51000','',''],['7','Jih','Šimek','29000','','']],
    },
    answerCell: 'E3',
    hint: '=SUMIF(A2:A7,"Jih",C2:C7)',
    checkFn: (f) => normalizeFormula(f) === 'SUMIF(A2:A7,"JIH",C2:C7)' || normalizeFormula(f) === 'SUMIF(A2:A7,E2,C2:C7)',
    correctFormula: '=SUMIF(A2:A7,"Jih",C2:C7)', expectedResult: '88 000 Kč',
  },
  {
    funcId: 'SUMIF',
    ...
    table: {
      headers: ['','A','B','C','D','E','F'],
      rows: [['1','Zaměstnanec','Oddělení','','Bonus','CELKEM IT','❓'],['2','Novák','IT','','12000','',''],['3','Benešová','HR','','8000','',''],['4','Svoboda','IT','','15000','',''],['5','Černý','Finance','','10000','',''],['6','Dvořák','IT','','14000','',''],['7','Poláková','HR','','9000','',''],['8','Kovář','IT','','11000','',''],['9','Procházka','Finance','','13000','','']],
    },
    answerCell: 'F1',
    hint: '=SUMIF(B2:B9,"IT",D2:D9)',
    checkFn: (f) => normalizeFormula(f) === 'SUMIF(B2:B9,"IT",D2:D9)',
    correctFormula: '=SUMIF(B2:B9,"IT",D2:D9)', expectedResult: '52 000 Kč',
  },
  {
    funcId: 'SUMIF',
    ...
    table: {
      headers: ['','A','B','C','D','E'],
      rows: [['1','Úkol','Délka (h)','Status','Celkem hotovo','❓'],['2','Úkol A','5','Hotovo','',''],['3','Úkol B','3','Probíhá','',''],['4','Úkol C','8','Hotovo','',''],['5','Úkol D','2','Nezahájeno','',''],['6','Úkol E','6','Hotovo','',''],['7','Úkol F','4','Probíhá','',''],['8','Úkol G','7','Hotovo','','']],
    },
    answerCell: 'E1',
    hint: '=SUMIF(C2:C8,"Hotovo",B2:B8)',
    checkFn: (f) => normalizeFormula(f) === 'SUMIF(C2:C8,"HOTOVO",B2:B8)',
    correctFormula: '=SUMIF(C2:C8,"Hotovo",B2:B8)', expectedResult: '26 h',
  },
  {
    funcId: 'SUMIF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Produkt','Tržby','Součet Tablet','❓'],['2','Notebook','50000','',''],['3','Tablet','15000','',''],['4','Telefon','30000','',''],['5','Tablet','12000','',''],['6','Tablet','18000','','']],
    },
    answerCell: 'D1',
    hint: '=SUMIF(A2:A6,"Tablet",B2:B6)',
    checkFn: (f) => normalizeFormula(f) === 'SUMIF(A2:A6,"TABLET",B2:B6)',
    correctFormula: '=SUMIF(A2:A6,"Tablet",B2:B6)', expectedResult: '45 000 Kč',
  },
  {
    funcId: 'SUMIF',
    ...
    table: {
      headers: ['','C','D','E','F','G'],
      rows: [['1','Zaměstnanec','Směna','Hodiny','Noční celkem','❓'],['2','Novák','Ranní','8','',''],['3','Beneš','Noční','12','',''],['4','Svoboda','Ranní','8','',''],['5','Kovář','Noční','10','',''],['6','Polák','Odpolední','6','',''],['7','Dvořák','Noční','12','',''],['8','Černá','Ranní','8','',''],['9','Procházka','Noční','10','',''],['10','Veselý','Odpolední','6','','']],
    },
    answerCell: 'G1',
    hint: '=SUMIF(D2:D10,"Noční",E2:E10)',
    checkFn: (f) => normalizeFormula(f) === 'SUMIF(D2:D10,"NOČNÍ",E2:E10)' || normalizeFormula(f.replace(/NO[CČ]NÍ/,'NOČNÍ')) === 'SUMIF(D2:D10,"NOČNÍ",E2:E10)',
    correctFormula: '=SUMIF(D2:D10,"Noční",E2:E10)', expectedResult: '44 h',
  },
  {
    funcId: 'SUMIF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Produkt','Kusy','Celkem XYZ','❓'],['2','ABC','50','',''],['3','XYZ','30','',''],['4','DEF','20','',''],['5','XYZ','45','',''],['6','XYZ','15','',''],['7','GHI','10','','']],
    },
    answerCell: 'D1',
    hint: '=SUMIF(A2:A7,"XYZ",B2:B7)',
    checkFn: (f) => normalizeFormula(f) === 'SUMIF(A2:A7,"XYZ",B2:B7)',
    correctFormula: '=SUMIF(A2:A7,"XYZ",B2:B7)', expectedResult: '90 ks',
  },
  {
    funcId: 'SUMIF',
    ...
    table: {
      headers: ['','A','B','C','D','E','F'],
      rows: [['1','Projekt','Vedoucí','Priorita','Náklady','Celkem vysoká','❓'],['2','Alpha','Novák','Vysoká','200000','',''],['3','Beta','Beneš','Střední','120000','',''],['4','Gamma','Černá','Vysoká','300000','',''],['5','Delta','Dvořák','Nízká','80000','',''],['6','Epsilon','Polák','Vysoká','150000','','']],
    },
    answerCell: 'F1',
    hint: '=SUMIF(C2:C6,"Vysoká",D2:D6)',
    checkFn: (f) => normalizeFormula(f) === 'SUMIF(C2:C6,"VYSOKÁ",D2:D6)',
    correctFormula: '=SUMIF(C2:C6,"Vysoká",D2:D6)', expectedResult: '650 000 Kč',
  },
  {
    funcId: 'SUMIF',
    ...
    table: {
      headers: ['','A','B','C','D','E'],
      rows: [['1','Parcela','Typ','Výměra (ha)','Celkem les','❓'],['2','1','Orná','12','',''],['3','2','Les','25','',''],['4','3','Pastvina','8','',''],['5','4','Les','30','',''],['6','5','Les','15','',''],['7','6','Orná','20','','']],
    },
    answerCell: 'E1',
    hint: '=SUMIF(B2:B7,"Les",C2:C7)',
    checkFn: (f) => normalizeFormula(f) === 'SUMIF(B2:B7,"LES",C2:C7)',
    correctFormula: '=SUMIF(B2:B7,"Les",C2:C7)', expectedResult: '70 ha',
  },
  {
    funcId: 'SUMIF',
    ...
    table: {
      headers: ['','A','B','C','D'],
      rows: [['1','Kategorie','Body','Celkem A','❓'],['2','A','85','',''],['3','B','72','',''],['4','A','90','',''],['5','C','65','',''],['6','A','78','',''],['7','B','88','',''],['8','A','95','',''],['9','C','55','','']],
    },
    answerCell: 'D1',
    hint: '=SUMIF(A2:A9,"A",B2:B9)',
    checkFn: (f) => normalizeFormula(f) === 'SUMIF(A2:A9,"A",B2:B9)',
    correctFormula: '=SUMIF(A2:A9,"A",B2:B9)', expectedResult: '348',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Položka','Hodnota','Zaokrouhleno'],['2','Pi','3.14159',''],['3','Euler','2.71828','❓'],['4','Zlatý řez','1.61803','']],
    },
    answerCell: 'C3',
    hint: '=ROUND(B3,1)',
    checkFn: (f) => normalizeFormula(f) === 'ROUND(B3,1)',
    correctFormula: '=ROUND(B3,1)', expectedResult: '2,7',
  },
  {
    funcId: 'ROUND',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Položka','Hodnota','Zaokrouhleno'],['2','DPH sazba','0.21','❓'],['3','Koeficient','0.9167',''],['4','Marže','0.375','']],
    },
    answerCell: 'C2',
    hint: '=ROUND(B2,0)',
    checkFn: (f) => normalizeFormula(f) === 'ROUND(B2,0)',
    correctFormula: '=ROUND(B2,0)', expectedResult: '0',
  },
  {
    funcId: 'ROUND',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Položka','Hodnota','Zaokrouhleno'],['2','Podíl','0.66666','❓'],['3','Odmocnina','1.41421',''],['4','Faktoriál','0.83333','']],
    },
    answerCell: 'C2',
    hint: '=ROUND(B2,3)',
    checkFn: (f) => normalizeFormula(f) === 'ROUND(B2,3)',
    correctFormula: '=ROUND(B2,3)', expectedResult: '0,667',
  },
  {
    funcId: 'ROUND',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Položka','Hodnota','Zaokrouhleno'],['2','Objednávka','1249','❓'],['3','Tržba','3670',''],['4','Rozpočet','9876','']],
    },
    answerCell: 'C2',
    hint: '=ROUND(B2,-2) zaokrouhlí na stovky',
    checkFn: (f) => normalizeFormula(f) === 'ROUND(B2,-2)',
    correctFormula: '=ROUND(B2,-2)', expectedResult: '1 200',
  },
  {
    funcId: 'ROUND',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Položka','Hodnota','Zaokrouhleno'],['2','Spotřeba L','36.78','❓'],['3','Vzdálenost km','142.3',''],['4','Váha kg','5.52','']],
    },
    answerCell: 'C2',
    hint: '=ROUND(B2,0)',
    checkFn: (f) => normalizeFormula(f) === 'ROUND(B2,0)',
    correctFormula: '=ROUND(B2,0)', expectedResult: '37',
  },
  {
    funcId: 'ROUND',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Položka','Hodnota','Zaokrouhleno'],['2','Kurz EUR','25.1678','❓'],['3','Kurz USD','22.5543',''],['4','Kurz GBP','29.8156','']],
    },
    answerCell: 'C2',
    hint: '=ROUND(B2,2)',
    checkFn: (f) => normalizeFormula(f) === 'ROUND(B2,2)',
    correctFormula: '=ROUND(B2,2)', expectedResult: '25,17',
  },
  {
    funcId: 'ROUND',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Položka','Hodnota','Zaokrouhleno'],['2','Rozpočet','124567','❓'],['3','Výdaje','98765',''],['4','Zisk','45678','']],
    },
    answerCell: 'C2',
    hint: '=ROUND(B2,-3) zaokrouhlí na tisíce',
    checkFn: (f) => normalizeFormula(f) === 'ROUND(B2,-3)',
    correctFormula: '=ROUND(B2,-3)', expectedResult: '125 000',
  },
  {
    funcId: 'ROUND',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Položka','Hodnota','Zaokrouhleno'],['2','Procento','87.456','❓'],['3','Procento','33.333',''],['4','Procento','66.789','']],
    },
    answerCell: 'C2',
    hint: '=ROUND(B2,1)',
    checkFn: (f) => normalizeFormula(f) === 'ROUND(B2,1)',
    correctFormula: '=ROUND(B2,1)', expectedResult: '87,5',
  },
  {
    funcId: 'ROUND',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Položka','Hodnota','Zaokrouhleno'],['2','Váha kg','1234','❓'],['3','Váha kg','567',''],['4','Váha kg','89','']],
    },
    answerCell: 'C2',
    hint: '=ROUND(B2,-1) zaokrouhlí na desítky',
    checkFn: (f) => normalizeFormula(f) === 'ROUND(B2,-1)',
    correctFormula: '=ROUND(B2,-1)', expectedResult: '1 230',
  },
  ...
  },
  {
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Město','PSČ','Lokalita'],['2','Praha','11000','❓'],['3','Brno','60200',''],['4','Ostrava','70200','']],
    },
    answerCell: 'C2',
    hint: '=CONCATENATE(A2,", ",B2)',
    checkFn: (f) => normalizeFormula(f) === 'CONCATENATE(A2,", ",B2)' || normalizeFormula(f) === 'A2&", "&B2',
    correctFormula: '=CONCATENATE(A2,", ",B2)', expectedResult: '"Praha, 11000"',
  },
  {
    funcId: 'CONCATENATE',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Zkratka','Název','Celý'],['2','CZ','Česká republika','❓'],['3','SK','Slovensko',''],['4','PL','Polsko','']],
    },
    answerCell: 'C2',
    hint: '=CONCATENATE(A2,". ",B2)',
    checkFn: (f) => normalizeFormula(f) === 'CONCATENATE(A2,". ",B2)' || normalizeFormula(f) === 'A2&". "&B2',
    correctFormula: '=CONCATENATE(A2,". ",B2)', expectedResult: '"CZ. Česká republika"',
  },
  {
    funcId: 'CONCATENATE',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Jméno','Doména','E-mail'],['2','jan.novak','firma.cz','❓'],['3','eva.cerna','firma.cz',''],['4','petr.prochazka','email.cz','']],
    },
    answerCell: 'C2',
    hint: '=CONCATENATE(A2,"@",B2)',
    checkFn: (f) => normalizeFormula(f) === 'CONCATENATE(A2,"@",B2)' || normalizeFormula(f) === 'A2&"@"&B2',
    correctFormula: '=CONCATENATE(A2,"@",B2)', expectedResult: '"jan.novak@firma.cz"',
  },
  {
    funcId: 'CONCATENATE',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Objednávka','Datum','Info'],['2','OBJ-001','1.3.2024','❓'],['3','OBJ-002','15.4.2024',''],['4','OBJ-003','30.6.2024','']],
    },
    answerCell: 'C2',
    hint: '=CONCATENATE(A2," ze dne ",B2)',
    checkFn: (f) => normalizeFormula(f) === 'CONCATENATE(A2," ZE DNE ",B2)' || normalizeFormula(f) === 'A2&" ZE DNE "&B2',
    correctFormula: '=CONCATENATE(A2," ze dne ",B2)', expectedResult: '"OBJ-001 ze dne 1.3.2024"',
  },
  {
    funcId: 'CONCATENATE',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Značka','Model','Vůz'],['2','Škoda','Octavia','❓'],['3','Volkswagen','Golf',''],['4','BMW','X5','']],
    },
    answerCell: 'C2',
    hint: '=CONCATENATE(A2," ",B2)',
    checkFn: (f) => normalizeFormula(f) === 'CONCATENATE(A2," ",B2)' || normalizeFormula(f) === 'A2&" "&B2',
    correctFormula: '=CONCATENATE(A2," ",B2)', expectedResult: '"Škoda Octavia"',
  },
  {
    funcId: 'CONCATENATE',
    ...
    table: {
      headers: ['', 'A', 'B', 'C', 'D'],
      rows: [['1','Den','Měsíc','Rok','Datum'],['2','1','1','2024','❓'],['3','15','6','2024',''],['4','24','12','2024','']],
    },
    answerCell: 'D2',
    hint: '=CONCATENATE(A2,".",B2,".",C2)',
    checkFn: (f) => normalizeFormula(f) === 'CONCATENATE(A2,".",B2,".",C2)',
    correctFormula: '=CONCATENATE(A2,".",B2,".",C2)', expectedResult: '"1.1.2024"',
  },
  {
    funcId: 'CONCATENATE',
    ...
    table: {
      headers: ['', 'A', 'B', 'C', 'D'],
      rows: [['1','Ulice','Č.p.','Město','Adresa'],['2','Hlavní','123','Praha','❓'],['3','Dlouhá','45','Brno',''],['4','Krátká','7','Plzeň','']],
    },
    answerCell: 'D2',
    hint: '=CONCATENATE(A2,", ",B2,", ",C2)',
    checkFn: (f) => normalizeFormula(f) === 'CONCATENATE(A2,", ",B2,", ",C2)',
    correctFormula: '=CONCATENATE(A2,", ",B2,", ",C2)', expectedResult: '"Hlavní, 123, Praha"',
  },
  {
    funcId: 'CONCATENATE',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Typ','ID','Kód'],['2','FAKT','2024-001','❓'],['3','OBJ','2024-045',''],['4','POP','2024-012','']],
    },
    answerCell: 'C2',
    hint: '=CONCATENATE(A2,"-",B2)',
    checkFn: (f) => normalizeFormula(f) === 'CONCATENATE(A2,"-",B2)' || normalizeFormula(f) === 'A2&"-"&B2',
    correctFormula: '=CONCATENATE(A2,"-",B2)', expectedResult: '"FAKT-2024-001"',
  },
  {
    funcId: 'CONCATENATE',
    ...
    table: {
      headers: ['', 'A', 'B', 'C'],
      rows: [['1','Budova','Místnost','Umístění'],['2','A','205','❓'],['3','B','312',''],['4','C','101','']],
    },
    answerCell: 'C2',
    hint: '=CONCATENATE(A2,"/",B2)',
    checkFn: (f) => normalizeFormula(f) === 'CONCATENATE(A2,"/",B2)' || normalizeFormula(f) === 'A2&"/"&B2',
    correctFormula: '=CONCATENATE(A2,"/",B2)', expectedResult: '"A/205"',
  },
];
